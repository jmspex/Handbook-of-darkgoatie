...
client.giveawaysManager = new GiveawaysManager(client, {
    storage: toString(client.info.database),
    updateCountdownEvery: parseInt(client.info.editinterval),
    default: {
        botsCanWin: false,
        embedColor: toString(client.info.embedcolor),
        reaction: toString(client.info.reaction)
    }
});
